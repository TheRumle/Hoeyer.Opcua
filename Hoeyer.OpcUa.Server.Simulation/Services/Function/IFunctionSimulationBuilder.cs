...
public interface IFunctionSimulationBuilder<TEntity, TArguments>
{
    IFunctionSimulationBuilder<TEntity, TArguments> ChangeState(
        Action<SimulationStepContext<TEntity, TArguments>> stateChange);

    IFunctionSimulationBuilder<TEntity, TArguments> Wait(TimeSpan timeSpan);
    ...
    IEnumerable<ISimulationStep> WithReturnValue<TReturn>(
