    ...
    where T : TypeDeclarationSyntax
{
    ...
    {
        IEnumerable<UsingDirectiveSyntax> usings = await GetImports(cancellationToken);
        UsingDirectiveSyntax u = SyntaxFactory.UsingDirective(SyntaxFactory.IdentifierName(NameSpace.ToString()));
    ...
    {
        IEnumerable<UsingDirectiveSyntax> usingDirectives = await GetImportsAndContainingNamespace(cancellationToken);
