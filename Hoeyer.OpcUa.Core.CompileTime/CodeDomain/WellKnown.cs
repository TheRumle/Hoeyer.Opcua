...
public static class WellKnown
{
    public static class FullyQualifiedAttribute
    {
        ...
        public static readonly FullyQualifiedTypeName
            LegalRangeAlarmAttribute = GetTypeName("LegalRangeAlarmAttribute");

        public static readonly FullyQualifiedTypeName MaximumThresholdExceededAlarmAttribute =
            GetTypeName("MaximumThresholdExceededAlarmAttribute");

        public static readonly FullyQualifiedTypeName MinimumThresholdExceededAlarmAttribute =
            GetTypeName("MinimumThresholdExceededAlarmAttribute");
