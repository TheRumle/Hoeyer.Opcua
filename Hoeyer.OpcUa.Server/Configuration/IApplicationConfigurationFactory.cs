...
public interface IApplicationConfigurationFactory
{
    ...
    /// See
    /// <see href="https://reference.opcfoundation.org/Core/Part6/v105/docs/6.2" />
    /// for information about
    /// <paramref name="subject" />
    /// and its further detail
    public ApplicationConfiguration CreateServerConfiguration(string subject, string[] legalDomains);
}