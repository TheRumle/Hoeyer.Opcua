...
/// <summary>
///     Given number of <see cref="IEntityObjectStateCreator" /> and an <see cref="IApplicationConfigurationFactory" />,
///     will construct instances of <see cref="ApplicationInstance" />, load the <see cref="ApplicationConfiguration" />
///     provided by the factory into the instance. The <see cref="IEntityObjectStateCreator" /> are used to create OpcUa
///     nodes for all classes marked with the <see cref="OpcUaEntityAttribute" />.
/// </summary>
