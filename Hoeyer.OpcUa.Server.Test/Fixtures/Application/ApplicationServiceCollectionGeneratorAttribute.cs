...
{
    /// <inheritdoc />
    public override IEnumerable<Func<ApplicationServiceCollectionFixture>> GenerateDataSources(DataGeneratorMetadata dataGeneratorMetadata)
    {
        return GeneratedTypes
            .EntityNodeCreators
            .Select(creator => (Func<ApplicationServiceCollectionFixture>)(() => new ApplicationServiceCollectionFixture(creator)));
    }
}