...
namespace Hoeyer.OpcUa.Client.Abstractions;

[SuppressMessage("Maintainability", "S3265",
    Justification = "The Opc.Ua library is not designed using Flags - unfortunately")]
