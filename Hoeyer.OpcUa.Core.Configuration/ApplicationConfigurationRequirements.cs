...
internal record ApplicationConfigurationRequirements : IApplicationConfigurationRequirements
{
    public ApplicationConfigurationRequirements(string serverId, string serverName, Uri host, Uri applicationNamespace,
        CertificateConfiguration security)
    {
    ...
    public CertificateConfiguration CertificateConfiguration { get; }
