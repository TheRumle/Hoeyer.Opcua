...
using Hoeyer.OpcUa.Client.Infrastructure.Configuration.Entities.Property.Errors;
using Opc.Ua;

namespace Hoeyer.OpcUa.Client.Services.BuildingServices;

public sealed class SupportedVariableTypeCallbackHandler
{
    /// <summary>
    ...
    public T HandleType<T>(Func<T> effect, BuiltInType type)
    {
        return type switch
        {
            // Supported types
