...
///     The index of the global namespace for the configuration/application. See
///     <see href="https://reference.opcfoundation.org/v104/Core/docs/Part3/8.2.2/" /> for details on namespaces and their
///     usage.
/// </param>
