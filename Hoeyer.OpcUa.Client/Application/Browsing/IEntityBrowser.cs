...
public interface IEntityBrowser
{
    ...
    /// </summary>
    /// <param name="session">The session connected to the OpcUa server. See <seealso cref="Hoeyer.OpcUa.Client.Application.MachineProxy.IEntitySessionFactory"/> <seealso cref="Session"/> </param>
