...
public sealed class EntityChangeAggregatorStrategy<T>(EntityMonitoringConfiguration configuration, IEntityBrowser<T> browser) : IEntityChangeAggregatorStrategy<T>
{
    ...
    public void Register(MonitoredItemNotification item)
    {
        ...
        var interval = configuration.EntityStabilisationTime;
    }
}